    ...
    return (
        <section>
            ...
            <footer className="footer-main">
                <form action="" name="emailForm" className="footer-form">
                    <input
                        type="email"
                        name=""
                        id=""
                ...
                <div className="social-links">
                    <menu className="social-menu">
                        <li>
                            <a
                                href="index.html"
                                aria-label="find us in facebook"
                                class="social-icon-container icon"
                            >
                                <svg
                        ...
                        <li>
                            <a
                                href="index.html"
                                aria-label="find us in pinterest"
                                class="social-icon-container icon"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
